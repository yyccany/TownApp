package com.example.townapp.feature.human_narrative.npc.util
...
class NpcLifecycleManager(
    ...
    fun onYearAdvanced(): List<LifecycleEvent> {
        ...
        val updatedStatuses = mutableListOf<com.example.townapp.feature.human_narrative.npc.model.NpcStatus>()
     ...
     * 纯函数：只根据输入计算输出，无副作用
     */
    private fun evolveOneYear(status: com.example.townapp.feature.human_narrative.npc.model.NpcStatus): com.example.townapp.feature.human_narrative.npc.model.NpcStatus {
