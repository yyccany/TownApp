...
val completeClothingItems = listOf(
    ...
    // --- 鞋履扩展 (1051~1055) ---
    ClothingItem(1051, "跑步鞋", "鞋履", fabrics = listOf("网布", "EVA", "橡胶"), fabricRatios = listOf(0.4, 0.3, 0.3), price = 399.0, expectedLifespanMonths = 18.0, maxWearsPerYear = 80, versatilityScore = 0.4, comfortScore = 0.85, durabilityScore = 0.6, qualityScore = 0.65, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.4, matchingDifficulty = 0.5, plannedObsolescence = 0.3, materialDegradation = 0.2, color = "灰白色"),
    ClothingItem(1052, "帆布鞋", "鞋履", fabrics = listOf("帆布", "橡胶"), fabricRatios = listOf(0.6, 0.4), price = 149.0, expectedLifespanMonths = 24.0, maxWearsPerYear = 60, versatilityScore = 0.6, comfortScore = 0.6, durabilityScore = 0.55, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.3, matchingDifficulty = 0.3, plannedObsolescence = 0.2, materialDegradation = 0.2, color = "白色"),
    ClothingItem(1053, "雨靴", "鞋履", fabrics = listOf("橡胶"), fabricRatios = listOf(1.0), price = 79.0, expectedLifespanMonths = 60.0, maxWearsPerYear = 15, versatilityScore = 0.2, comfortScore = 0.4, durabilityScore = 0.9, qualityScore = 0.5, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.1, matchingDifficulty = 0.2, plannedObsolescence = 0.1, materialDegradation = 0.05, color = "军绿色"),
    ClothingItem(1054, "居家拖鞋", "鞋履", fabrics = listOf("EVA", "棉"), fabricRatios = listOf(0.7, 0.3), price = 29.0, expectedLifespanMonths = 12.0, maxWearsPerYear = 200, versatilityScore = 0.2, comfortScore = 0.8, durabilityScore = 0.3, qualityScore = 0.3, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.05, matchingDifficulty = 0.1, plannedObsolescence = 0.5, materialDegradation = 0.3, color = "灰色"),
    ClothingItem(1055, "厚底老爹鞋", "鞋履", fabrics = listOf("网布", "合成革", "EVA"), fabricRatios = listOf(0.3, 0.3, 0.4), price = 499.0, expectedLifespanMonths = 30.0, maxWearsPerYear = 70, versatilityScore = 0.5, comfortScore = 0.75, durabilityScore = 0.65, qualityScore = 0.6, isIQTax = true, iqTaxLevel = 1, decisionDifficulty = 0.5, matchingDifficulty = 0.5, plannedObsolescence = 0.2, materialDegradation = 0.15, color = "白色"),

    // --- 袜子扩展 (1056~1060) ---
    ClothingItem(1056, "运动袜(3双装)", "袜子", fabrics = listOf("棉", "涤纶", "氨纶"), fabricRatios = listOf(0.7, 0.2, 0.1), price = 29.0, expectedLifespanMonths = 8.0, maxWearsPerYear = 100, versatilityScore = 0.3, comfortScore = 0.75, durabilityScore = 0.4, qualityScore = 0.45, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.1, matchingDifficulty = 0.15, plannedObsolescence = 0.5, materialDegradation = 0.3, color = "白色"),
    ClothingItem(1057, "羊毛袜(2双装)", "袜子", fabrics = listOf("羊毛", "尼龙"), fabricRatios = listOf(0.7, 0.3), price = 49.0, expectedLifespanMonths = 18.0, maxWearsPerYear = 40, versatilityScore = 0.25, comfortScore = 0.85, durabilityScore = 0.65, qualityScore = 0.6, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.2, matchingDifficulty = 0.2, plannedObsolescence = 0.3, materialDegradation = 0.2, color = "深灰色"),
    ClothingItem(1058, "船袜(5双装)", "袜子", fabrics = listOf("棉", "氨纶"), fabricRatios = listOf(0.8, 0.2), price = 25.0, expectedLifespanMonths = 6.0, maxWearsPerYear = 80, versatilityScore = 0.25, comfortScore = 0.6, durabilityScore = 0.25, qualityScore = 0.3, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.05, matchingDifficulty = 0.1, plannedObsolescence = 0.6, materialDegradation = 0.35, color = "黑色"),
    ClothingItem(1059, "中筒袜(3双装)", "袜子", fabrics = listOf("棉", "涤纶"), fabricRatios = listOf(0.75, 0.25), price = 35.0, expectedLifespanMonths = 10.0, maxWearsPerYear = 70, versatilityScore = 0.3, comfortScore = 0.7, durabilityScore = 0.45, qualityScore = 0.45, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.1, matchingDifficulty = 0.15, plannedObsolescence = 0.45, materialDegradation = 0.25, color = "白色"),
    ClothingItem(1060, "五指袜(3双装)", "袜子", fabrics = listOf("棉", "氨纶"), fabricRatios = listOf(0.8, 0.2), price = 45.0, expectedLifespanMonths = 8.0, maxWearsPerYear = 50, versatilityScore = 0.15, comfortScore = 0.65, durabilityScore = 0.35, qualityScore = 0.35, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.15, matchingDifficulty = 0.2, plannedObsolescence = 0.5, materialDegradation = 0.3, color = "白色"),

    // --- 帽子扩展 (1061~1065) ---
    ClothingItem(1061, "遮阳帽", "帽子", fabrics = listOf("棉", "聚酯纤维"), fabricRatios = listOf(0.6, 0.4), price = 49.0, expectedLifespanMonths = 24.0, maxWearsPerYear = 30, versatilityScore = 0.25, comfortScore = 0.65, durabilityScore = 0.5, qualityScore = 0.4, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.2, matchingDifficulty = 0.25, plannedObsolescence = 0.2, materialDegradation = 0.15, color = "米色"),
    ClothingItem(1062, "针织毛线帽", "帽子", fabrics = listOf("腈纶", "羊毛"), fabricRatios = listOf(0.6, 0.4), price = 69.0, expectedLifespanMonths = 36.0, maxWearsPerYear = 25, versatilityScore = 0.3, comfortScore = 0.8, durabilityScore = 0.7, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.2, matchingDifficulty = 0.3, plannedObsolescence = 0.15, materialDegradation = 0.2, color = "黑色"),
    ClothingItem(1063, "渔夫帽", "帽子", fabrics = listOf("纯棉"), fabricRatios = listOf(1.0), price = 79.0, expectedLifespanMonths = 36.0, maxWearsPerYear = 35, versatilityScore = 0.35, comfortScore = 0.7, durabilityScore = 0.6, qualityScore = 0.5, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.25, matchingDifficulty = 0.3, plannedObsolescence = 0.15, materialDegradation = 0.15, color = "卡其色"),
    ClothingItem(1064, "空顶帽", "帽子", fabrics = listOf("聚酯纤维", "棉"), fabricRatios = listOf(0.6, 0.4), price = 49.0, expectedLifespanMonths = 18.0, maxWearsPerYear = 30, versatilityScore = 0.2, comfortScore = 0.55, durabilityScore = 0.4, qualityScore = 0.35, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.15, matchingDifficulty = 0.2, plannedObsolescence = 0.25, materialDegradation = 0.2, color = "白色"),
    ClothingItem(1065, "贝雷帽", "帽子", fabrics = listOf("羊毛", "涤纶"), fabricRatios = listOf(0.5, 0.5), price = 129.0, expectedLifespanMonths = 48.0, maxWearsPerYear = 20, versatilityScore = 0.3, comfortScore = 0.65, durabilityScore = 0.7, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 1, decisionDifficulty = 0.35, matchingDifficulty = 0.4, plannedObsolescence = 0.1, materialDegradation = 0.1, color = "红色"),

    // --- 裙装扩展 (1066~1072) ---
    ClothingItem(1066, "A字裙", "裙装", fabrics = listOf("棉", "氨纶"), fabricRatios = listOf(0.97, 0.03), price = 149.0, expectedLifespanMonths = 24.0, maxWearsPerYear = 35, versatilityScore = 0.5, comfortScore = 0.7, durabilityScore = 0.6, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.3, matchingDifficulty = 0.35, plannedObsolescence = 0.15, materialDegradation = 0.1, color = "黑色"),
    ClothingItem(1067, "包臀裙", "裙装", fabrics = listOf("聚酯纤维", "氨纶"), fabricRatios = listOf(0.92, 0.08), price = 129.0, expectedLifespanMonths = 18.0, maxWearsPerYear = 30, versatilityScore = 0.4, comfortScore = 0.55, durabilityScore = 0.5, qualityScore = 0.5, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.4, matchingDifficulty = 0.4, plannedObsolescence = 0.2, materialDegradation = 0.15, color = "黑色"),
    ClothingItem(1068, "长裙(拖地)", "裙装", fabrics = listOf("棉", "粘胶纤维"), fabricRatios = listOf(0.5, 0.5), price = 199.0, expectedLifespanMonths = 36.0, maxWearsPerYear = 20, versatilityScore = 0.4, comfortScore = 0.8, durabilityScore = 0.6, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 1, decisionDifficulty = 0.4, matchingDifficulty = 0.5, plannedObsolescence = 0.15, materialDegradation = 0.1, color = "碎花"),
    ClothingItem(1069, "格子短裙", "裙装", fabrics = listOf("聚酯纤维"), fabricRatios = listOf(1.0), price = 99.0, expectedLifespanMonths = 18.0, maxWearsPerYear = 30, versatilityScore = 0.35, comfortScore = 0.55, durabilityScore = 0.45, qualityScore = 0.4, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.35, matchingDifficulty = 0.4, plannedObsolescence = 0.2, materialDegradation = 0.15, color = "红蓝格"),
    ClothingItem(1070, "牛仔裙", "裙装", fabrics = listOf("纯棉"), fabricRatios = listOf(1.0), price = 159.0, expectedLifespanMonths = 36.0, maxWearsPerYear = 30, versatilityScore = 0.5, comfortScore = 0.6, durabilityScore = 0.75, qualityScore = 0.6, isIQTax = false, iqTaxLevel = 0, decisionDifficulty = 0.3, matchingDifficulty = 0.3, plannedObsolescence = 0.1, materialDegradation = 0.1, color = "浅蓝色"),
    ClothingItem(1071, "纱裙(蓬蓬裙)", "裙装", fabrics = listOf("网纱", "涤纶"), fabricRatios = listOf(0.7, 0.3), price = 249.0, expectedLifespanMonths = 24.0, maxWearsPerYear = 15, versatilityScore = 0.25, comfortScore = 0.6, durabilityScore = 0.35, qualityScore = 0.4, isIQTax = true, iqTaxLevel = 1, decisionDifficulty = 0.5, matchingDifficulty = 0.6, plannedObsolescence = 0.2, materialDegradation = 0.15, color = "白色"),
    ClothingItem(1072, "针织半身裙", "裙装", fabrics = listOf("羊毛", "腈纶"), fabricRatios = listOf(0.4, 0.6), price = 199.0, expectedLifespanMonths = 24.0, maxWearsPerYear = 25, versatilityScore = 0.45, comfortScore = 0.75, durabilityScore = 0.55, qualityScore = 0.55, isIQTax = false, iqTaxLevel = 1, decisionDifficulty = 0.35, matchingDifficulty = 0.4, plannedObsolescence = 0.15, materialDegradation = 0.2, color = "灰色"),
)
...
val extendedBuildingMaterials = listOf(
    MaterialItem(id = 5011, name = "碎石", category = "建材", unit = "吨", pricePerUnit = 120.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "混凝土骨料"),
    MaterialItem(id = 5012, name = "大理石", category = "建材", unit = "平方米", pricePerUnit = 350.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "高档地面装饰石材"),
    MaterialItem(id = 5013, name = "花岗岩", category = "建材", unit = "平方米", pricePerUnit = 280.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "室外地面/墙面石材"),
    MaterialItem(id = 5014, name = "石膏板", category = "建材", unit = "平方米", pricePerUnit = 25.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "室内吊顶隔墙材料"),
    MaterialItem(id = 5015, name = "矿棉板", category = "建材", unit = "平方米", pricePerUnit = 35.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "吸音吊顶材料"),
    MaterialItem(id = 5016, name = "防水卷材", category = "建材", unit = "卷", pricePerUnit = 350.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "屋顶防水材料"),
    MaterialItem(id = 5017, name = "保温板", category = "建材", unit = "平方米", pricePerUnit = 45.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "外墙保温材料"),
    MaterialItem(id = 5018, name = "铝合金门窗", category = "建材", unit = "平方米", pricePerUnit = 500.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "断桥铝门窗"),
    MaterialItem(id = 5019, name = "不锈钢管", category = "建材", unit = "米", pricePerUnit = 30.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "扶手/管道不锈钢材料"),
    MaterialItem(id = 5020, name = "PVC地板", category = "建材", unit = "平方米", pricePerUnit = 60.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "塑胶地板材料"),
    MaterialItem(id = 5021, name = "实木地板", category = "建材", unit = "平方米", pricePerUnit = 200.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "高档实木地板"),
    MaterialItem(id = 5022, name = "乳胶漆", category = "建材", unit = "桶", pricePerUnit = 300.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "内墙环保涂料"),
    MaterialItem(id = 5023, name = "墙纸", category = "建材", unit = "卷", pricePerUnit = 150.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "壁纸装饰材料"),
    MaterialItem(id = 5024, name = "水泥砂浆", category = "建材", unit = "吨", pricePerUnit = 300.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "砌筑抹灰材料"),
    MaterialItem(id = 5025, name = "钢筋网", category = "建材", unit = "平方米", pricePerUnit = 80.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "混凝土增强材料"),
    MaterialItem(id = 5026, name = "石灰", category = "建材", unit = "吨", pricePerUnit = 250.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "建筑石灰材料"),
    MaterialItem(id = 5027, name = "河沙", category = "建材", unit = "吨", pricePerUnit = 80.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "细沙,混凝土用"),
    MaterialItem(id = 5028, name = "玻璃棉", category = "建材", unit = "平方米", pricePerUnit = 30.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "保温隔音材料"),
    MaterialItem(id = 5029, name = "防火板", category = "建材", unit = "平方米", pricePerUnit = 55.0, contactType = ContactType.NON_CONTACT, colorId = 10, description = "防火装饰板材"),
    MaterialItem(id = 5030, name = "硅钙板", category = "建材", unit = "平方米", pricePerUnit = 20.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "轻质隔墙材料"),
)
...
val extendedElectronicMaterials = listOf(
    MaterialItem(id = 6011, name = "内存条", category = "电子料", unit = "条", pricePerUnit = 200.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "DDR4/DDR5内存模组"),
    MaterialItem(id = 6012, name = "固态硬盘", category = "电子料", unit = "个", pricePerUnit = 300.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "SSD存储"),
    MaterialItem(id = 6013, name = "CPU处理器", category = "电子料", unit = "个", pricePerUnit = 1500.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "中央处理器"),
    MaterialItem(id = 6014, name = "GPU显卡", category = "电子料", unit = "个", pricePerUnit = 3000.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "图形处理器"),
    MaterialItem(id = 6015, name = "主板", category = "电子料", unit = "片", pricePerUnit = 800.0, contactType = ContactType.NON_CONTACT, colorId = 4, description = "PCB主板"),
    MaterialItem(id = 6016, name = "电源适配器", category = "电子料", unit = "个", pricePerUnit = 80.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "充电器/电源模块"),
    MaterialItem(id = 6017, name = "扬声器", category = "电子料", unit = "个", pricePerUnit = 25.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "微型扬声器模组"),
    MaterialItem(id = 6018, name = "麦克风", category = "电子料", unit = "个", pricePerUnit = 15.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "微型麦克风"),
    MaterialItem(id = 6019, name = "散热器", category = "电子料", unit = "个", pricePerUnit = 60.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "CPU/芯片散热模组"),
    MaterialItem(id = 6020, name = "震动马达", category = "电子料", unit = "个", pricePerUnit = 10.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "手机震动马达"),
    MaterialItem(id = 6021, name = "NFC芯片", category = "电子料", unit = "个", pricePerUnit = 5.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "近场通信芯片"),
    MaterialItem(id = 6022, name = "WiFi模块", category = "电子料", unit = "个", pricePerUnit = 25.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "无线通信模块"),
    MaterialItem(id = 6023, name = "蓝牙芯片", category = "电子料", unit = "个", pricePerUnit = 8.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "蓝牙通信芯片"),
    MaterialItem(id = 6024, name = "GPS模块", category = "电子料", unit = "个", pricePerUnit = 20.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "定位导航模块"),
    MaterialItem(id = 6025, name = "指纹传感器", category = "电子料", unit = "个", pricePerUnit = 30.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "生物识别传感器"),
    MaterialItem(id = 6026, name = "电池保护板", category = "电子料", unit = "片", pricePerUnit = 15.0, contactType = ContactType.NON_CONTACT, colorId = 4, description = "锂电池保护电路"),
    MaterialItem(id = 6027, name = "柔性电路板", category = "电子料", unit = "片", pricePerUnit = 40.0, contactType = ContactType.NON_CONTACT, colorId = 4, description = "FPC柔性板"),
    MaterialItem(id = 6028, name = "电阻电容套装", category = "电子料", unit = "套", pricePerUnit = 10.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "被动元器件"),
    MaterialItem(id = 6029, name = "连接器", category = "电子料", unit = "个", pricePerUnit = 5.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "电子连接器"),
    MaterialItem(id = 6030, name = "天线模组", category = "电子料", unit = "个", pricePerUnit = 12.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "通信天线"),
)
...
val extendedIndustrialMaterials = listOf(
    MaterialItem(id = 7011, name = "钛合金", category = "工业料", unit = "吨", pricePerUnit = 280000.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "高强度轻质合金"),
    MaterialItem(id = 7012, name = "不锈钢304", category = "工业料", unit = "吨", pricePerUnit = 15000.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "食品级不锈钢"),
    MaterialItem(id = 7013, name = "镀锌板", category = "工业料", unit = "吨", pricePerUnit = 6000.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "防腐钢板"),
    MaterialItem(id = 7014, name = "硅胶", category = "工业料", unit = "千克", pricePerUnit = 40.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "密封/绝缘材料"),
    MaterialItem(id = 7015, name = "聚氨酯", category = "工业料", unit = "吨", pricePerUnit = 18000.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "高性能塑料"),
    MaterialItem(id = 7016, name = "环氧树脂", category = "工业料", unit = "千克", pricePerUnit = 50.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "高性能粘接材料"),
    MaterialItem(id = 7017, name = "陶瓷纤维", category = "工业料", unit = "千克", pricePerUnit = 80.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "耐高温材料"),
    MaterialItem(id = 7018, name = "合成橡胶", category = "工业料", unit = "吨", pricePerUnit = 15000.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "丁苯橡胶等"),
    MaterialItem(id = 7019, name = "铝合金(工业)", category = "工业料", unit = "吨", pricePerUnit = 20000.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "工业铝合金型材"),
    MaterialItem(id = 7020, name = "铜合金", category = "工业料", unit = "吨", pricePerUnit = 70000.0, contactType = ContactType.NON_CONTACT, colorId = 3, description = "黄铜/青铜等"),
    MaterialItem(id = 7021, name = "石墨", category = "工业料", unit = "千克", pricePerUnit = 60.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "润滑/导电材料"),
    MaterialItem(id = 7022, name = "稀土材料", category = "工业料", unit = "千克", pricePerUnit = 500.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "磁性材料/催化剂"),
    MaterialItem(id = 7023, name = "碳化硅", category = "工业料", unit = "千克", pricePerUnit = 200.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "超硬材料"),
    MaterialItem(id = 7024, name = "亚克力板", category = "工业料", unit = "千克", pricePerUnit = 25.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "透明塑料板材"),
    MaterialItem(id = 7025, name = "聚四氟乙烯", category = "工业料", unit = "千克", pricePerUnit = 150.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "PTFE特种塑料"),
    MaterialItem(id = 7026, name = "镀铬剂", category = "工业料", unit = "升", pricePerUnit = 80.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "表面处理材料"),
    MaterialItem(id = 7027, name = "焊料", category = "工业料", unit = "千克", pricePerUnit = 100.0, contactType = ContactType.NON_CONTACT, colorId = 5, description = "焊接材料"),
    MaterialItem(id = 7028, name = "涂料(工业)", category = "工业料", unit = "桶", pricePerUnit = 800.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "工业防腐涂料"),
    MaterialItem(id = 7029, name = "碳纳米管", category = "工业料", unit = "克", pricePerUnit = 50.0, contactType = ContactType.NON_CONTACT, colorId = 2, description = "纳米新材料"),
    MaterialItem(id = 7030, name = "生物降解塑料", category = "工业料", unit = "吨", pricePerUnit = 12000.0, contactType = ContactType.NON_CONTACT, colorId = 1, description = "环保材料"),
)
...
val extendedHousingProducts = listOf(
    ProductItem(id = 8009, name = "小户型LOFT", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 3, shapeType = PixelShapeType.VERTICAL, description = "40-60㎡ 挑高复式"),
    ProductItem(id = 8010, name = "大平层", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 3, shapeType = PixelShapeType.SQUARE, description = "200-300㎡ 平层豪宅"),
    ProductItem(id = 8011, name = "四合院", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 4, shapeType = PixelShapeType.SQUARE, description = "传统中式院落 300㎡+"),
    ProductItem(id = 8012, name = "度假别墅", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 4, shapeType = PixelShapeType.SQUARE, description = "依山傍水 500㎡+"),
    ProductItem(id = 8013, name = "学生公寓", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 5, shapeType = PixelShapeType.VERTICAL, description = "高校周边 15-30㎡"),
    ProductItem(id = 8014, name = "养老公寓", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 3, shapeType = PixelShapeType.SQUARE, description = "适老化设计 50-80㎡"),
    ProductItem(id = 8015, name = "社区商铺", category = "房产", contactType = ContactType.NON_CONTACT, colorId = 3, shapeType = PixelShapeType.HORIZONTAL, description = "底商 30-80㎡"),
)
...
val extendedDigitalProducts = listOf(
    ProductItem(id = 9009, name = "真无线耳机", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.SQUARE, description = "ANC主动降噪 | 蓝牙5.3 | IPX5防水 | 续航8h+32h充电仓 | 触控操作"),
    ProductItem(id = 9010, name = "头戴式耳机", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.SQUARE, description = "HiFi 50mm动圈 | 有线+LDAC无线 | 频响5Hz-40kHz | 阻抗32Ω | 300g"),
    ProductItem(id = 9011, name = "智能手表Pro", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.SQUARE, description = "eSIM独立通话 | 钛合金表壳 | 蓝宝石玻璃 | ECG心电 | 深度计100m"),
    ProductItem(id = 9012, name = "平板电脑Mini", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.HORIZONTAL, description = "8.3寸 LiquidRetina | A15芯片 | 64GB | 支持手写笔 | 297g超便携"),
    ProductItem(id = 9013, name = "游戏主机", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.SQUARE, description = "4K 120fps | 16GB GDDR6 | 1TB NVMe SSD | 光线追踪 | 双无线手柄"),
    ProductItem(id = 9014, name = "数码相机", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.SQUARE, description = "APS-C 2420万像素 | 4K60fps视频 | 五轴防抖 | ISO100-32000"),
    ProductItem(id = 9015, name = "投影仪", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.SQUARE, description = "1080P LED光源 | 800ANSI流明 | 自动对焦/梯形校正 | 寿命30000h"),
    ProductItem(id = 9016, name = "路由器", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.HORIZONTAL, description = "WiFi6 AX3000 | 双频2.4G+5G | 4×千兆口 | OFDMA | 支持Mesh"),
    ProductItem(id = 9017, name = "移动硬盘", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 5, shapeType = PixelShapeType.SQUARE, description = "2TB USB3.2 | 读取1050MB/s | 硬件加密 | 防震硅胶套 | 免驱"),
    ProductItem(id = 9018, name = "智能音箱", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 5, shapeType = PixelShapeType.SQUARE, description = "AI语音助手 | 2.5寸全频喇叭 | WiFi+蓝牙 | 智能家居控制 | 12W"),
    ProductItem(id = 9019, name = "电子书阅读器", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.HORIZONTAL, description = "7寸墨水屏 300PPI | 冷暖双色温 | 32GB | 防水IPX8 | 续航数周"),
    ProductItem(id = 9020, name = "VR头显", category = "数码", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.SQUARE, description = "骁龙XR2 Gen2 | 单眼2160×2160 | 90Hz | 6DoF追踪 | 530g"),
)
...
val extendedCarProducts = listOf(
    ProductItem(id = 10009, name = "混合动力轿车", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.HORIZONTAL, description = "油电混动 省油"),
    ProductItem(id = 10010, name = "纯电SUV", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.HORIZONTAL, description = "续航700km 纯电"),
    ProductItem(id = 10011, name = "皮卡车", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 5, shapeType = PixelShapeType.HORIZONTAL, description = "双排座 载货1吨"),
    ProductItem(id = 10012, name = "自行车(山地)", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 3, shapeType = PixelShapeType.HORIZONTAL, description = "21速 山地车"),
    ProductItem(id = 10013, name = "电动车(48V)", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 1, shapeType = PixelShapeType.VERTICAL, description = "新国标 代步"),
    ProductItem(id = 10014, name = "滑板车(电动)", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 2, shapeType = PixelShapeType.VERTICAL, description = "便携 短途代步"),
    ProductItem(id = 10015, name = "三轮车(电动)", category = "汽车", contactType = ContactType.NON_CONTACT, colorId = 4, shapeType = PixelShapeType.HORIZONTAL, description = "载货400kg 快递"),
)
...
val extendedCompositions = listOf(
    ...
    // --- 新数码DIY配件组成 (9021~9031) ---
    // 显卡 RTX4060
    CompositionRelation(9021, 6004, 1.0, "个"),      // GPU核心芯片
    CompositionRelation(9021, 6002, 0.1, "千克"),    // 铜箔(散热片)
    CompositionRelation(9021, 6006, 1.0, "片"),      // PCB电路板
    CompositionRelation(9021, 6007, 1.0, "个"),      // 塑料外壳/风扇罩
    CompositionRelation(9021, 7002, 0.3, "千克"),    // 铝材(散热鳍片)
    // 显卡 RTX4070
    CompositionRelation(9022, 6004, 1.0, "个"),      // GPU核心芯片
    CompositionRelation(9022, 6002, 0.15, "千克"),   // 铜箔
    CompositionRelation(9022, 6006, 1.0, "片"),      // PCB电路板
    CompositionRelation(9022, 6007, 1.0, "个"),      // 塑料外壳
    CompositionRelation(9022, 7002, 0.4, "千克"),    // 铝材
    // CPU i5-13400F
    CompositionRelation(9023, 6001, 0.5, "片"),      // 硅晶圆(芯片基底)
    CompositionRelation(9023, 6004, 1.0, "个"),      // 处理器芯片
    CompositionRelation(9023, 6002, 0.05, "千克"),   // 铜箔(顶盖)
    // CPU i7-13700K
    CompositionRelation(9024, 6001, 0.6, "片"),
    CompositionRelation(9024, 6004, 1.0, "个"),
    CompositionRelation(9024, 6002, 0.06, "千克"),
    // SSD 1TB
    CompositionRelation(9025, 6001, 0.3, "片"),      // 硅晶圆(NAND闪存)
    CompositionRelation(9025, 6004, 1.0, "个"),      // 主控芯片
    CompositionRelation(9025, 6006, 1.0, "片"),      // PCB
    CompositionRelation(9025, 7002, 0.05, "千克"),   // 铝材(散热标签)
    // SSD 2TB
    CompositionRelation(9026, 6001, 0.5, "片"),
    CompositionRelation(9026, 6004, 1.0, "个"),
    CompositionRelation(9026, 6006, 1.0, "片"),
    // HDD 4TB
    CompositionRelation(9027, 7002, 0.3, "千克"),    // 铝材(外壳+盘片)
    CompositionRelation(9027, 7001, 0.1, "千克"),    // 钢材(马达)
    CompositionRelation(9027, 6004, 1.0, "个"),      // 主控芯片
    CompositionRelation(9027, 6006, 1.0, "片"),      // PCB
    // DDR5内存
    CompositionRelation(9028, 6001, 0.2, "片"),      // 硅晶圆(DRAM颗粒)
    CompositionRelation(9028, 6006, 1.0, "片"),      // PCB
    CompositionRelation(9028, 7002, 0.08, "千克"),   // 铝材(散热片)
    // 主板 Z790
    CompositionRelation(9029, 6006, 1.0, "片"),      // PCB(多层板)
    CompositionRelation(9029, 6002, 0.08, "千克"),   // 铜箔(走线)
    CompositionRelation(9029, 6004, 3.0, "个"),      // 芯片组+BIOS+网卡等
    CompositionRelation(9029, 6007, 1.0, "个"),      // 塑料(接口座)
    // 电源 850W
    CompositionRelation(9030, 6002, 0.2, "千克"),    // 铜箔(变压器线圈)
    CompositionRelation(9030, 7002, 0.5, "千克"),    // 铝材(外壳+散热)
    CompositionRelation(9030, 6006, 1.0, "片"),      // PCB
    CompositionRelation(9030, 6004, 2.0, "个"),      // 电源管理芯片
    CompositionRelation(9030, 7007, 0.3, "千克"),    // 塑料(风扇+接口)
    // CPU散热 240水冷
    CompositionRelation(9031, 7002, 0.6, "千克"),    // 铝材(冷排)
    CompositionRelation(9031, 6002, 0.1, "千克"),    // 铜(冷头底板)
    CompositionRelation(9031, 7007, 0.2, "千克"),    // 塑料(风扇框)
    CompositionRelation(9031, 7001, 0.05, "千克"),   // 钢材(扣具)
)
